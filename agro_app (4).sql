...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2025 a las 16:57:40
...
INSERT INTO `pagos` (`id_pago`, `id_usuario`, `id_agricultor`, `id_pedido`, `id_producto`, `nombre_cliente`, `monto_total`, `id_venta`, `transaccion_id`, `moneda`, `estado`, `metodo`, `fecha_pago`) VALUES
(0, NULL, NULL, '36', NULL, NULL, NULL, NULL, NULL, 'COP', 'pendiente', 'checkout', NULL);
...
(36, 12, '2025-09-25', 'pendiente', NULL);
...
(1, 20, 'peticion', 'Arreglen la Navbar ', 'Lololol', '2025-09-22', 'respondido', 'Estamos trabajando en ello, tener paciencia ', '2025-09-22', NULL),
(2, 20, 'peticion', 'lol q mal se daño todooo', 'loooool ', '2025-09-22', 'respondido', 'Si? Que bueno', '2025-09-22', NULL);
...
(18, 4, 2, 'otra papa ', 'Papa', 500, 10000, 3, '68c0fab3a72f3_mucha papa.jpg', '2025-09-22'),
...
(20, 6, 6, 'los mejores frijoles bola roja que te puedes comer ', 'frijoles', 1000, 5000, 3, '68c119e129caa_3000.jpg', '2025-09-22'),
...
(24, 7, 6, 'Bola Roja', 'Frijoles', 500, 2000, 3, '68c17175c5a3a_68c0fadc338e9_pexels-arina-krasnikova-6316686.jpg', '2025-09-22'),
...
(60, 7, 5, 'Manzana fresca de la region', 'Manzana Roja', 300, 2500, NULL, NULL, '2025-10-01'),
(61, 7, 1, 'Zanahoria organica fresca', 'Zanahoria', 100, 1800, NULL, NULL, '2025-10-01'),
(62, 7, 2, 'Papa pastusa premium', 'Papa', 160, 2000, 3, NULL, '2025-10-01');
...
(1, 18, 20, 5, 'Buena papa', '2025-09-22 10:15:43'),
(2, 18, 20, 3, 'salio dañada', '2025-09-22 10:15:58'),
(3, 18, 20, 4, 'llego en buen estado, pero muy pequeñas', '2025-09-22 10:16:18'),
(4, 22, 20, 5, 'Muy frescas, y pudimos recibirlas el mismo día', '2025-09-22 10:20:34'),
(5, 22, 20, 5, 'Pocas veces he recibido un producto tan fresco, muchas gracias', '2025-09-22 10:21:02'),
(6, 23, 20, 5, 'Unas ricas zanahorias, buen tamaño, y un buen estado, se entregaron el día acordado', '2025-09-22 10:22:08');
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT de la tabla `pedido_detalle`
--
ALTER TABLE `pedido_detalle`
  MODIFY `id_pedido_detalle` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
